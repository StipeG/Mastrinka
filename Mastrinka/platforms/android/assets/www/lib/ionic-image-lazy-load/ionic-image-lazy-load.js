    ...
    function ($document, $timeout, $animate, $ionicScrollDelegate, $compile) {
        return {
            ...
            link: function ($scope, $element, $attributes) {
                ...
                var loadDefImage;
                if ($attributes.imageLazyDefaultClass) {
                    loadDefImage = $compile('<div class="image-loader-container ' + $attributes.imageLazyDefaultClass + '"></div>')($scope);
                    $element.after(loadDefImage);
                }
                ...
                function loadImage() {
                    ...
                    $element.bind("load", function (e) {
                        ...
                        $element.addClass('lazy-image-class-loaded');
